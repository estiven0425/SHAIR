...
miBoton.addEventListener('click', function() {
    ...
    if (miBoton.innerHTML === '<img src="http://localhost/SHAIR/elements/sun.svg" alt="">') {
        // Cambia el contenido del botón cuando se hace clic
        miBoton.innerHTML = '<img src="http://localhost/SHAIR/elements/dark.svg" alt="">';
    } else {
        // Puedes restablecer el contenido a su estado original si es necesario
        miBoton.innerHTML = '<img src="http://localhost/SHAIR/elements/sun.svg" alt="">';
    }
});
