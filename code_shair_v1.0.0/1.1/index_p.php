    ...
    <section id="content"> <!--Inicio de sección de contenido principal-->
        ...
        <div id="featured_applications"> <!--Contenedor de aplicaciones destacadas-->
            ...
            <div id="featured"> <!--Contenedor de aplicaciones-->
                <a href="./index_a.php"> <img src="http://localhost/SHAIR/elements/storefront.svg" alt="Aplicación destacada"></a> <!--Aplicación destacada-->
                <a href="./index_a.php"> <img src="http://localhost/SHAIR/elements/storefront.svg" alt="Aplicación destacada"></a> <!--Aplicación destacada-->
                <a href="./index_a.php"> <img src="http://localhost/SHAIR/elements/storefront.svg" alt="Aplicación destacada"></a> <!--Aplicación destacada-->
                <a href="./index_a.php"> <img src="http://localhost/SHAIR/elements/storefront.svg" alt="Aplicación destacada"></a> <!--Aplicación destacada-->
                <a href="./index_a.php"> <img src="http://localhost/SHAIR/elements/storefront.svg" alt="Aplicación destacada"></a> <!--Aplicación destacada-->
        ...
        <div id="content_list"> <!--Lista de contenido-->
            ...
            <div class="list_principal"> <!--Lista-->
                ...
                <a class="article" href="./index_a.php">  <!--Artículos-->
                    ...
                    <img src="http://localhost/SHAIR/elements/game.svg" alt=""> <!--Imágen del artículo-->
                    <p>Nombre</p> <!--Nombre del artículo-->
            ...
            <div class="list_principal"> <!--Lista-->
                ...
                <a class="article" href="./index_c.php">  <!--Artículos-->
                    ...
                    <img src="http://localhost/SHAIR/elements/person.svg" alt=""> <!--Imágen del artículo-->
                    <p>Nombre</p> <!--Nombre del artículo-->
