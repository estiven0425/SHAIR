    ...
    <style>
        ...
        * {
        ...
        #content { /*Estilo para el contenedor principal*/
            align-items: stretch; /*Alineamos horizontalmente que cubra toda la pantalla*/
        ...
        #content #featured_applications { /*Estilo para contenedor de aplicaciones destacadas*/
            align-items: stretch; /*Estiramos horizontalmente*/
            display: flex; /*Display flexible*/
            flex-direction: column; /*Dirección de columna*/
            justify-content: space-between; /*Espacio vertical igualado entre los items*/
        }

        #content #featured_applications #tittle { /*Estilo para el contenedor del título*/
            align-items: center; /*Alineamos verticalmente al centro*/
            display: flex; /*Display flexible*/
            justify-content: center; /*Alineamos horizontalmente en el centro*/
        }

        #content #featured_applications #tittle h1 { /*Estilo para el título*/
            color: rgb(40, 65, 224); /*Color de fuente*/
            text-transform: uppercase; /*Todo en mayúsculas*/
        }

        #content #featured_applications #featured { /*Estilo para el contenedor de aplicaciones destacadas*/
            align-items: center; /*Alineamos verticalmente al centro*/
            display: flex; /*Display flexible*/
            flex-direction: row; /*Dirección horizontal*/
            flex-wrap: nowrap; /*Solo una fila*/
            justify-content: space-between; /*Alineados horizontalmente con espacio entre ellos*/
        }

        #content #featured_applications #featured a { /*Estilo para los productos destacados*/
            margin: 0px; /*Margen*/
            width: 15%; /*Anchura*/
        }

        #content #featured_applications #featured a img { /*Estilo para la imagen del producto destacado*/
            height: 250px;
            border-radius: 25px;
            width: 250px; /*Anchura*/
            transition: transform 0.3s ease-in-out; /*Transición para agrandar*/
        ...
        #content #featured_applications #featured a img:hover {
...
<body> <!--Cuerpo de la página-->
    ...
    <header> <!--Cabecera-->
        ...
        <div id="enter/exit">
            <button id="login">Unirte</button>
        </div>

        <div id="enter/exit">
            <button id="login_alt">iniciar sesión</button>
        </div>

        <div id="enter/exit">
            <button id="theme"><img src="http://localhost/SHAIR-main/elements/sun.svg" alt=""></button>
        </div>
    ...
    <section id="content"> <!--Inicio de sección de contenido principal-->
        ...
        <div id="featured_applications"> <!--Contenedor de aplicaciones destacadas-->
                
            <div id="tittle"> <!--Contenedor de título-->
                <h1>aplicaciones destacadas</h1> <!--Título-->
            </div> <!--Fin contenedor título-->

            <div id="featured"> <!--Contenedor de aplicaciones-->
                <a href="./index_a.php"> <img src="http://localhost/shaiR-main/elements/storefront.svg" alt="Aplicación destacada"></a> <!--Aplicación destacada-->
                <a href="./index_a.php"> <img src="http://localhost/shaiR-main/elements/storefront.svg" alt="Aplicación destacada"></a> <!--Aplicación destacada-->
                <a href="./index_a.php"> <img src="http://localhost/shaiR-main/elements/storefront.svg" alt="Aplicación destacada"></a> <!--Aplicación destacada-->
                <a href="./index_a.php"> <img src="http://localhost/shaiR-main/elements/storefront.svg" alt="Aplicación destacada"></a> <!--Aplicación destacada-->
                <a href="./index_a.php"> <img src="http://localhost/shaiR-main/elements/storefront.svg" alt="Aplicación destacada"></a> <!--Aplicación destacada-->
            </div> <!--Fin contenedor aplicaciones-->

        </div> <!--Fin contenedor destacadas-->
