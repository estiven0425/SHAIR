<?php
    ...
    if ($_SERVER["REQUEST_METHOD"] == "POST") {
        ...
        $sql = "SELECT id_creador, nombre, descripcion FROM creador WHERE correo = '$correo' AND contraseña = '$contrasena'";
        ...
        if ($result->num_rows == 1) {
            ...
            $_SESSION["id_creador"] = $row["id_creador"];
            $_SESSION["nombre"] = $row["nombre"];
            $_SESSION["descripcion"] = $row["descripcion"];
            header("Location: index_cp.php"); // Cambia esto al nombre de tu página de inicio exitoso
        } else {
