...
function CrearCuenta() {
  ...
  const handleSubmit = (e) => {
    ...
    if (!formData.AceptaCondiciones) {
      setErrorMessage(
        "Debe aceptar las políticas y condiciones para crear una cuenta."
      );
      return;
    }
    ...
    axios
      .post(
        "http://localhost/SHAIR/shair_v200/src/BD_v200/ApiCrearUsuario.php",
        formData
      )
      .then((response) => {
          ...
          <>
            <Row className="mb-3CrearCuentaNombres">
              ...
              <Form.Group as={Col} controlId="formGridNickName">
                <Form.Label className="TextoLabel">
                  Nombre de usuario
                </Form.Label>
                <Form.Control
                  className="Input"
            ...
            <Form.Group
              className="mb-3CrearCuentaDescripcion"
            ...
            <Form.Group
              className="mb-3CrearCuentaContrato"
              id="formGridCheckbox"
            >
              <Form.Check
                ...
                label={
                  <p>
                    Al hacer clic acepta nuestras{" "}
                    <a href="#">políticas y condiciones</a>.
                  </p>
                }
