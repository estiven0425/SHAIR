  ...
  const handleSubmit = async (e) => {
    ...
    try {
      ...
      const response = await axios.post(
        "http://localhost/SHAIR/shair_v200/src/BD_v200/ApiCrearEspacio.php",
        espacioData
      );
    ...
    <div id="CrearEspacioPrincipal">
      <div id="FormularioCrearEspacio">
        <Form onSubmit={handleSubmit}>
          ...
          <Form.Group
            className="mb-3CrearEspacioDescripcion"
          ...
          <Form.Group
            className="mb-3CrearEspacioContrato"
            id="formGridCheckbox"
          >
            <Form.Check
