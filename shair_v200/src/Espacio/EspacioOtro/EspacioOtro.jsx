...
const EspacioOtro = () => {
  ...
  useEffect(() => {
    ...
    axios.get(`http://localhost/SHAIR/shair_v200/src/BD_v200/ApiLeerEspacioOtro.php?IdEspacio=${IdEspacio}`)
      .then(response => {
    ...
    <div id='PrincipalEspacioOtro'>
      ...
      <div id='bodyEspacioOtro'>
        ...
        <section id='DerechoEspacioOtro'> 
          <LateralDerechoHome isLoggedIn={isLoggedIn} IdUsuario={IdUsuario} location="EspacioOtro" />
        </section>
      </div>
    </div>
  );
