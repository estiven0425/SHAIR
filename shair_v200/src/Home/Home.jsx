...
export default function Home() {
  ...
  useEffect(() => {
    axios
      .get("http://localhost/SHAIR/shair_v200/src/BD_v200/ApiLeerEspacio.php")
      .then((response) => {
        ...
        <section id="CentroHome">
          <div id="NoticiaCentroHome">
            <a href="#" id="NoticiaCentroHomenN">
              ...
              <p>
                Debido a los crecientes problemas en el inicio de sesión, se
                está considerando la opción de eliminar esta mecánica de la
                plataforma, agradecemos su comprensión y lamentamos cualquier
                problema relacionado al inicio de sesión, el equipo de
                desarrollo de SHAIR implementará acciones de emergencia para la
                entrega de fase, simulando un inicio de sesión y habilitando
                funciones exclusivas del inicio de sesión en la pantalla
                principal, esto con el fin de cumplir con el porcentaje de
                proyecto requerido para la entrega de fase. Lamentamos
                nuevamente los problemas ocacionados por nuestro programador.
                <br></br>
                <hr></hr>
            ...
            {espacioData.map((item) => (
              ...
              >
                <div className="EspacioCentroHome">
                  ...
                  <p>
                    Creado por:{" "}
                    <a href={`/UsuarioOtro/${item.IdUsuario}`}>
                      {item.NombreUsuario}
                    </a>
                  </p>
