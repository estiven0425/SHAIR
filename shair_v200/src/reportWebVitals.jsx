...
const reportWebVitals = (onPerfEntry) => {
  //Se define una función llamada reportWebVitals que toma un argumento llamado onPerfEntry, que es una función.

  if (onPerfEntry && onPerfEntry instanceof Function) {
    //Se verifica si onPerfEntry existe y es una función antes de continuar.

    import("web-vitals").then(({ getCLS, getFID, getFCP, getLCP, getTTFB }) => {
      //Se importan funciones específicas relacionadas con métricas de rendimiento desde el módulo 'web-vitals'.
