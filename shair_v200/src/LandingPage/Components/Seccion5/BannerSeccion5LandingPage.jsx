...
export default function BannerSeccion5LandingPage() { // Exportamos una función llamada BannerSeccion5LandingPage que retorna un elemento JSX
  return ( // Retornamos el contenido JSX del componente
    <div id='BannerSeccion5LandingPage'> {/* Creamos un div con id BannerSeccion5LandingPage que contiene un elemento img */}
