...
import './BannerSeccion5_2.css'; // Importamos el archivo de estilos CSS para el componente

export default function BannerSeccion5_2() { // Exportamos una función llamada BannerSeccion5_2 que retorna un elemento JSX
  return ( // Retornamos el contenido JSX del componente
    <div id='BannerSeccion5_2'> {/* Creamos un div con id BannerSeccion5_2 que contiene un elemento img */}
