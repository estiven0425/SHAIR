...
export default function BannerSeccion5_1LandingPage() { // Exportamos una función llamada BannerSeccion5_1LandingPage que retorna un elemento JSX
  return ( // Retornamos el contenido JSX del componente
    <div id='BannerSeccion5_1LandingPage'> {/* Creamos un div con id BannerSeccion5_1LandingPage que contiene un elemento img */}
