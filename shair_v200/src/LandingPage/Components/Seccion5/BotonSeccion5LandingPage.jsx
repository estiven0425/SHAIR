...
function BotonSeccion5LandingPage() {
  // Definimos una función llamada BotonSeccion5LandingPage que retorna un elemento JSX
  ...
  return (
    ...
    <>
      ...
      <div className="mb-5">
        {" "}
        {/* Creamos un div con la clase mb-5 que le da un margen inferior de 2 unidades */}
        ...
        >
          <a href="#Seccion1LandingPage">Volver arriba</a>{" "}
          {/* Dentro del botón, creamos un elemento a que renderiza un enlace con el texto "Volver arriba" y el atributo href con el valor "#Seccion1" para que al hacer clic se desplace a la sección 1 de la página*/}
        </Button>
      </div>
    </>
  );
