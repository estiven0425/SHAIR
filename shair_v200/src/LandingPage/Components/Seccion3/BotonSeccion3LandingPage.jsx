...
function BotonSeccion3LandingPage() {
  // Definimos una función llamada BotonSeccion3LandingPage que retorna un elemento JSX
  ...
  return (
    ...
    <>
      ...
      <div className="mb-3">
        {" "}
        {/* Creamos un div con la clase mb-3 que le da un margen inferior de 2 unidades */}
        ...
        >
          <a href="#Seccion4LandingPage">¡Adelante!</a>{" "}
          {/* Dentro del botón, creamos un elemento a que renderiza un enlace con el texto "!Adelante¡" y el atributo href con el valor "#Seccion4" para que al hacer clic se desplace a la sección 4 de la página */}
        </Button>
      </div>
    </>
  );
