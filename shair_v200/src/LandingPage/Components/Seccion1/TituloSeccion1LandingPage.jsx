...
export default function TituloSeccion1LandingPage() { // Exportamos una función llamada TituloSeccion1LandingPage que retorna un elemento JSX
  return ( // Retornamos el contenido JSX del componente
    <div id='TituloSeccion1LandingPage'> {/*} Creamos un div con id TituloSeccion1LandingPage que contiene un elemento h1 */}
