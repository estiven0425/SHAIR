...
export default function IconoSeccion1LandingPage() {
  // Exportamos una función llamada IconoSeccion1LandingPage que retorna un elemento JSX
  return (
    // Retornamos el contenido JSX del componente
    <div id="IconoSeccion1LandingPage">
      {" "}
      {/* Creamos un div con id IconoSeccion1LandingPage que contiene un elemento img */}
