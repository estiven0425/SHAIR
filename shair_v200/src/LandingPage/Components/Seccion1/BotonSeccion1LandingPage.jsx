...
function BotonSeccion1LandingPage() {
  // Definimos una función llamada BotonSeccion1LandingPage que retorna un elemento JSX
  ...
  return (
    ...
    <>
      ...
      <div className="mb-1">
        {" "}
        {/* Creamos un div con la clase mb-1 que le da un margen inferior de 2 unidades */}
        ...
        >
          <a href="#Seccion2LandingPage">Conócenos</a>{" "}
          {/* Dentro del botón, creamos un elemento a que renderiza un enlace con el texto "Conócenos" y el atributo href con el valor "#Seccion2" para que al hacer clic se desplace a la sección 2 de la página */}
        </Button>
      </div>
    </>
  );
