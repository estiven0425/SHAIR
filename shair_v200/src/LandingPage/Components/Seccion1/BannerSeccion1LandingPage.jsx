...
export default function BannerSeccion1LandingPage() { // Exportamos una función llamada BannerSeccion1LandingPage que retorna un elemento JSX
  return ( // Retornamos el contenido JSX del componente
    <div id='BannerSeccion1LandingPage'> {/* Creamos un div con id BannerSeccion1LandingPage que contiene un elemento img */}
