...
function BotonSeccion2LandingPage() {
  // Definimos una función llamada BotonSeccion2LandingPage que retorna un elemento JSX
  ...
  return (
    ...
    <>
      ...
      <div className="mb-2">
        ...
        >
          <a href="#Seccion3LandingPage">Mira lo que ofrecemos</a>{" "}
          {/* Dentro del botón, creamos un elemento a que renderiza un enlace con el texto "Mira lo que ofrecemos" y el atributo href con el valor "#Seccion3" para que al hacer clic se desplace a la sección 3 de la página */}
        </Button>
      </div>
    </>
  );
