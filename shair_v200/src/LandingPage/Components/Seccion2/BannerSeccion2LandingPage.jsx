...
export default function BannerSeccion2LandingPage() { // Exportamos una función llamada BannerSeccion2LandingPage que retorna un elemento JSX
  return ( // Retornamos el contenido JSX del componente
    <div id='BannerSeccion2LandingPage'> {/*} Creamos un div con id BannerSeccion2LandingPage que contiene un elemento img */}
