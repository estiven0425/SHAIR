...
export default function BarraFooterLandingPage() {
  return ( /* Definimos un componente funcional llamado BarraFooterLandingPage */
    <div id='BarraFooterLandingPage'> {/* Creamos un contenedor con el ID "BarraFooterLandingPage" que contiene dos secciones */}
      <div id='InformacionLandingPage'> {/* Sección de información que incluye varios componentes importados */}
        <UbicacionLandingPage />
        <ContactoLandingPage />
        <MasInformacionLandingPage />
        <CondicionesdeServicioLandingPage />
      </div>
      <div id='DerechosLandingPage'> {/* Sección de derechos que incluye el componente "Dueño" */}
        <DueñoLandingPage />
      </div>
    </div>
  );
