...
import './Ubicacion.css'; /* Importamos un archivo de estilos personalizados para el componente Ubicacion */

export default function Ubicacion() {
  return ( /* Definimos un componente funcional llamado Ubicacion */
    <div id='Ubicacion'> {/* Creamos un contenedor con el ID "Ubicacion" que contiene el contenido */}
