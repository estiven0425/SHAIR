...
export default function BarraDeNavegacionLandingPage() { /* Definimos un componente funcional llamado BarraDeNavegacionLandingPage */
  return (   
    <nav class="navbar navbar-expand-lg bg-body-tertiary-LandingPage"> {/* Creamos un elemento de navegación con clases de Bootstrap y una clase personalizada "bg-body-tertiary" */}     
      <div class="container-fluid"> {/* Creamos un contenedor fluido dentro de la barra de navegación */}
        ...
        <a class="navbar-brand" href='/Home'>Shair | Foro</a> {/* Creamos un tercer enlace con la clase "navbar-brand" y texto "Shair | Foro" */}
      </div>
    </nav>
  )
}
