...
export default function BannerSeccion4LandingPage() { // Exportamos una función llamada BannerSeccion4LandingPage que retorna un elemento JSX
  return ( // Retornamos el contenido JSX del componente
    <div id='BannerSeccion4LandingPage'> {/* Creamos un div con id BannerSeccion4LandingPage que contiene un elemento img */}
