...
function BotonSeccion4_1LandingPage() {
  // Definimos una función llamada BotonSeccion4_1LandingPage que retorna un elemento JSX
  ...
  return (
    ...
    <>
      ...
      <div className="mb-4_1">
        {" "}
        {/* Creamos un div con la clase mb-4_1 que le da un margen inferior de 2 unidades */}
        ...
        >
          <a href="/Home">Visitar catálogo</a>{" "}
          {/* Dentro del botón, creamos un elemento a que renderiza un enlace con el texto "Visitar catálogo" y el atributo href con el valor "#" para que al hacer clic se desplace a */}
        </Button>
      </div>
    </>
  );
